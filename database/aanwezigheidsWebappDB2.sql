...
-- Dumpen data van tabel zhuraibz001.courses: ~14 rows (ongeveer)
...
-- Dumpen data van tabel zhuraibz001.lessons: ~12 rows (ongeveer)
...
-- Dumpen data van tabel zhuraibz001.reglesson: ~9 rows (ongeveer)
